...
/* Find Customer header card (back bar + title) — Figma node 2960:223663 */
          ...
          <div className="flex w-full items-start gap-4">
            <div className="flex items-start">
              <div className="flex size-10 items-center justify-center rounded-lg bg-[linear-gradient(-90deg,#f05c62_0%,#e50075_100%)] p-2">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/icons/ui/zoom-plus-white.svg" alt="" className="block size-[22px]" />
              </div>
            </div>
            <div className="flex min-h-8 flex-col items-start justify-center gap-1">
              <p className="text-lg leading-6 font-bold whitespace-nowrap text-black/87">Find Customer</p>
            </div>
          </div>
        </div>
      </div>
